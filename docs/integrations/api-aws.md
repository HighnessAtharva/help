...
This guide provides the exact steps required to connect AWS API Gateway to AccuKnox API Security.

Deploy the CloudFormation template ->  Enable logging. Logs move through CloudWatch and Lambda. The AccuKnox API Agent receives them. The Control Plane builds your real-time inventory.
...
## 6. Optional: Create API Collections
